				...
				<%
				 ...
				 while(rs.next())
				 {
					 ...
					 <tr style="font-size: 11px;height: 20px;">
					    ...
					    <td style="vertical-align:middle;border-left: 1px solid;border-top: 1px solid;"><div align="center"><a href="ReplyTutor.jsp?tutorid=<%=rs.getInt("TutorId")%>">Reply</a></div></td>
					  </tr>
				<%} %>
            </table>
            <br>
