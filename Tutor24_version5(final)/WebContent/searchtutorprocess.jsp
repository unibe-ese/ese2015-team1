    ...
    <div class="singup">
        ...
        <div class="signup-main">
            ...
            <table style="width: 95%; margin-left: 20px; margin-right: 20px;border: 1px solid;">
				...
				PreparedStatement ps= con.prepareStatement("SELECT * FROM tbltutor");
				//PreparedStatement ps= con.prepareStatement("SELECT * FROM tbltutor where Education =? or SubjectsOffered like ?");
