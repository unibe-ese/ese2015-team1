    ...
    <div class="singup">
        ...
        <table style="width: 95%; margin-left: 20px; margin-right: 20px;border: 1px solid;">
                <tr style="background-color:#c9c9c9;height: 30px;font-size: 13px;">
					...
					<td style="vertical-align:middle;width:8%;border-left: 1px solid;color:#000000;"> </td>
				</tr>
				<%
				 ...
				 while(rs.next())
				 {
					 ...
					 <tr style="font-size: 11px;height: 20px;">
					    ...
					    <td style="vertical-align:middle;border-left: 1px solid;border-top: 1px solid;"><div align="center"><a href="ReplyStudent.jsp?studentid=<%=rs.getInt("StudentId")%>">Reply</a></div></td>
					  </tr>
				<%} %>
            </table>
            <br>
